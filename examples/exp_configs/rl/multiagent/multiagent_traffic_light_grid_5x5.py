...
from flow.controllers.grid_5x5_routes import OD_5_5, build_od_rates
...
SUMO_DIR = "/home/sdc_joran/Grid_5x5_Network"

net_params = NetParams(
    template={
        # Network geometry
        "net": os.path.join(SUMO_DIR, "Grid.net.xml"),

        # Route file(s) – must be a *list*, even if you only have one file
        "rou": [os.path.join(SUMO_DIR, "Grid.rou.xml")],
        # Vehicle type definitions
        "vtype": os.path.join(SUMO_DIR, "Grid.vtype.xml"),
    },
    additional_params={
        "turn_speed": 8.9,
...
flow_params = dict(
    ...
    exp_tag=   "multiagent_traffic_light_5x5_grid",
