    ...
    def specify_connections(self, net_params):
        ...
        for r in range(N_ROWS):
            for c in range(N_COLS):
                ...
                # ---- U-turns at every intersection (lane 3 only) ----
                conns += [
                    {"from": in_W,  "to": out_W,   "fromLane": "3", "toLane": "3"},  # west approach
                    {"from": in_S,  "to": out_S,   "fromLane": "3", "toLane": "3"},  # south approach
                    {"from": in_E,  "to": out_E,   "fromLane": "3", "toLane": "3"},  # east approach
                    {"from": in_N,  "to": out_N,   "fromLane": "3", "toLane": "3"},  # north approach
                ]
